        ...
        return (
          <View style={styles.container}>
            ...
            <View style={styles.body}>
                ...
                <Text style={{ textAlign:'center',padding:40}}>Please setyp a 6-digit PIN and biometric security for easy access in future</Text>
                ...
                <TouchableOpacity style={styles.button} onPress={()=>this.props.navigation.navigate('AccountSetupConfirm')}>
