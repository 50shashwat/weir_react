...
export default class PinLogin extends Component {
        ...
        return (
          <View style={styles.container}>
            ...
            <View style={styles.body}>
                ...
                <Text style={{ textAlign:'center',paddingBottom:40, paddingTop:10}}>Please enter your PIN</Text>
                ...
                <TouchableOpacity style={styles.button} onPress={this.openHome.bind(this)}>
    ...
    openHome(){
        this.props.navigation.replace('Devices')
    }
